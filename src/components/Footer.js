                                        ...
                                        <div className="row">
                                                    ...
                                                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                                        <div className="footer__widget">
                                                            ...
                                                            <div className="footer__widget-content">
                                                                <div className="footer__link">
                                                                    <ul>
                                                                        <li><a href="contact.html">Store Location</a>
                                                                        </li>
                                                                        <li><a href="my-account.html">My account</a>
                                                                        </li>
                                                                        <li><a href="contact.html">Order Tracking</a>
                                                                        </li>
                                            ...
                                            <div className="col-xl-5 col-lg-6 col-md-6 col-sm-6">
                                                <div className="footer__widget">
                                                    ...
                                                    <div className="footer__widget-content">
                                                        <p className="footer-text mb-35">Our mission statement is to
                                                            provide the absolute best customer experience available in
                                                            the Electronic industry without exception.</p>
                                                        <div
                                                            className="footer__hotline d-flex align-items-center mb-10">
                                ...
                                <div className="row">
                                    <div className="col-xl-12">
                                        ...
                                        <div className="payment-image text-center mb-25">
                                            <a href="contact.html"><img src="assets/img/payment/payment.png"
                                                alt="" /></a>
                                        </div>
                                        <div className="copy-right-area text-center">
                                            <p>Copyright © <span>DukaMarket.</span> All Rights Reserved. Powered by <a
                                                href="#"><span className="main-color">Theme_Pure.</span></a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
