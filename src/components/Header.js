...
function Header() {
    const backgroundImageUrl = process.env.PUBLIC_URL + '/assets/img/bg/menu-item.jpg';
    ...
    const subTotal = () => {
        ...
        cart.forEach(element => {
            total += (element.oldPrice * element.quantity)
        });
        return total
    }
                                ...
                                <div className="row align-items-center">
                                    <div className="col-xl-3 col-lg-3 col-md-4 col-sm-4">
                                        <div className="header__info">
                                            <div className="logo">
                                                <a href="index.html" className="logo-image"><img
                                                    src={process.env.PUBLIC_URL + "/img/logo/logo1.svg"}
                                                    alt="logo" /></a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="header__search">
                                            <form action="#">
                                                <div className="header__search-box">
                                                    ...
                                                    <button className="button" type="submit"><i
                                                        ...
                                                        <ul>
                                                                ...
                                                                cart && cart.map((item, index) => (
                                                                    <li key={index}>
                                                                        <div
                                                                            ...
                                                                            <div onClick={() => RemoveCart(item)} className="cart__del">
                                                            ...
                                                            <li>
                                                                <div
                                                                    ...
                                                                    <h6>Subtotal</h6>
                                                                    <span className="cart__sub-total">${subTotal()}</span>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <a href="cart.html" className="wc-cart mb-10">View
                                                                    cart</a>
                                                                <a href="checkout.html"
                                                                    className="wc-checkout">Checkout</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                ...
                                <div className="col-lg-3">
                                    <div className="cat__menu-wrapper side-border d-none d-lg-block">
                                        <div className="cat-toggle">
                                            <button type="button" className="cat-toggle-btn cat-toggle-btn-1"><i
                                                className="fal fa-bars" /> Shop by department
                                            </button>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="shop.html">All Categories <i
                                                                className="far fa-angle-down" /></a>
                                                            <ul className="mega-menu">
                                                                <li><a href="shop.html">Shop Pages</a>
                                                                    <ul className="mega-item">
                                                                        <li><a href="product-details.html">Standard SHop
                                                                            Page</a></li>
                                                                        <li><a href="product-details.html">Shop Right
                                                                            Sidebar</a></li>
                                                                        <li><a href="product-details.html">Shop Left
                                                                            Sidebar</a></li>
                                                                        <li><a href="product-details.html">Shop 3
                                                                            Column</a></li>
                                                                        <li><a href="product-details.html">Shop 4
                                                                            Column</a></li>
                                                                    </ul>
                                                                </li>
                                                                <li><a href="shop.html">Product Pages</a>
                                                                    <ul className="mega-item">
                                                                        ...
                                                                        <li><a href="product-details.html">Product
                                                                            V3</a></li>
                                                                        <li><a href="product-details.html">Varriable
                                                                            Product</a></li>
                                                                ...
                                                                <li><a href="shop.html">Other Pages</a>
                                                                    <ul className="mega-item">
                                                                        <li><a href="product-details.html">wishlist</a>
                                                                        </li>
                                                                        <li><a href="product-details.html">Shopping
                                                                            Cart</a></li>
                                                                        <li><a href="product-details.html">Checkout</a>
                                                                        </li>
                                                                        <li><a href="product-details.html">Login</a>
                                                                        </li>
                                                                        <li><a href="product-details.html">Register</a>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                                <li><a href="shop.html">Phone &amp; Tablets</a>
                                                                    <ul className="mega-item">
                                                                        <li><a href="product-details.html">Catagory
                                                                            1</a></li>
                                                                        <li><a href="product-details.html">Catagory
                                                                            2</a></li>
                                                                        <li><a href="product-details.html">Catagory
                                                        ...
                                                        <li>
                                                            <a href="shop.html">New Arrivals <i
                                                                className="far fa-angle-down" /></a>
                                                        ...
                                                        <li className="d-laptop-none"><a
                                                            href="shop.html">Fashion &amp; Clothings</a></li>
                                                        <li className="d-laptop-none"><a
                                                            href="shop.html">Jewelry &amp; Watches</a></li>
                                ...
                                <div className="col-lg-6 col-md-6 col-3">
                                    <div className="header__bottom-left d-flex d-xl-block align-items-center">
                                        <div className="side-menu d-lg-none mr-20">
                                            <button type="button" className="side-menu-btn offcanvas-toggle-btn"><i
                                        ...
                                        <div className="main-menu d-none d-lg-block">
                                            <nav>
                                                <ul>
                                                    <li>
                                                        <a href="index.html" className="active">Home <i
                                                            className="far fa-angle-down" /></a>
                                                        <ul className="megamenu-1">
                                                            <li><a href="index.html">Home Pages</a>
                                                                <ul className="mega-item">
                                                                    <li><a href="index.html" className="active">Home
                                                                        One</a></li>
                                                                    <li><a href="index-2.html">Home Two</a></li>
                                                                    <li><a href="index-3.html">Home Three</a></li>
                                                                    <li><a href="product-details.html">Shop 3 Column</a>
                                                                    </li>
                                                                    <li><a href="product-details.html">Shop 4 Column</a>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                                            <li><a href="shop.html">Product Pages</a>
                                                                <ul className="mega-item">
                                                                    <li><a href="product-details.html">Product
                                                                        Details</a></li>
                                                                    <li><a href="product-details.html">Product V2</a>
                                                                    </li>
                                                                    <li><a href="product-details.html">Product V3</a>
                                                                    </li>
                                                                    <li><a href="product-details.html">Varriable
                                                                        Product</a></li>
                                                                    <li><a href="product-details.html">External
                                                            ...
                                                            <li><a href="shop.html">Other Pages</a>
                                                                <ul className="mega-item">
                                                                    ...
                                                                    <li><a href="product-details.html">Shopping Cart</a>
                                                                    </li>
                                                            ...
                                                            <li><a href="shop.html">Phone &amp; Tablets</a>
                                                                <ul className="mega-item">
                                                                    <li><a href="product-details.html">Catagory 1</a>
                                                                    </li>
                                                                    <li><a href="product-details.html">Catagory 2</a>
                                                                    </li>
                                                                    <li><a href="product-details.html">Catagory 3</a>
                                                                    </li>
                                                                    <li><a href="product-details.html">Catagory 4</a>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                                            <li><a href="shop.html">Phone &amp; Tablets</a>
                                                    ...
                                                    <li><a href="about.html">About Us</a></li>
                                                    <li className="has-mega"><a href="shop.html">Shop <i
                                                        className="far fa-angle-down" /></a>
                                                        <div className="mega-menu">
                                                            <div className="container container-mega">
                                                                <ul>
                                                                    <li>
                                                                        <ul>
                                                                            <li className="title"><a href="shop.html">SHOP
                                                                                LAYOUT</a></li>
                                                                            <li><a href="shop.html">Pagination</a></li>
                                                                            <li><a href="shop.html">Ajax Load More</a>
                                                                            </li>
                                                                            <li><a href="shop.html">Infinite Scroll</a>
                                                                            </li>
                                                                            <li><a href="shop.html">Sidebar Right</a>
                                                                            </li>
                                                                    ...
                                                                    <li>
                                                                        <ul>
                                                                            ...
                                                                            <li><a href="shop.html">Small Products</a>
                                                                            </li>
                                                                            <li><a href="shop.html">Large Products</a>
                                                                            </li>
                                                                            <li><a href="shop.html">Shop — 3 Items</a>
                                                                            </li>
                                                                            <li><a href="shop.html">Shop — 4 Items</a>
                                                                            </li>
                                                                            <li><a href="shop.html">Shop — 5 Items</a>
                                                                            </li>
                                                                        </ul>
                                                                    </li>
                                                                    <li>
                                                                        <ul>
                                                                            <li className="title"><a href="shop.html">PRODUCT
                                                                                LAYOUT</a></li>
                                                                            <li><a href="shop.html">Description
                                                                                Sticky</a></li>
                                                                            <li><a href="shop.html">Product Carousel</a>
                                                                            </li>
                                                                            <li><a href="shop.html">Gallery Modern</a>
                                                                            </li>
                                                                            <li><a href="shop.html">Thumbnail Left</a>
                                                                            </li>
                                                                            <li><a href="shop.html">Thumbnail Right</a>
                                                                            </li>
                                                                            <li><a href="shop.html">Thumbnail
                                                                                Botttom</a></li>
                                                                        </ul>
                                                                    </li>
                                                                    <li>
                                                                        <ul>
                                                                            <li className="title"><a
                                                                                href="shop.html">Basketball</a></li>
                                                                            <li><a href="shop.html">East Hampton
                                                                                Fleece</a></li>
                                                                            <li><a href="shop.html">Faxon Canvas Low</a>
                                                                            </li>
                                                                            <li><a href="shop.html">Habitasse
                                                                                Dictumst</a></li>
                                                                            <li><a href="shop.html">Kaoreet Lobortis</a>
                                                                            </li>
                                                                            <li><a href="shop.html">NikeCourt Zoom</a>
                                                                            </li>
                                                                            <li><a href="shop.html">NikeCourts Air
                                                                                Zoom</a></li>
                                                                        </ul>
                                                                    </li>
                                                                    <li>
                                                                    ...
                                                                    <li className="mega-image hover-effect"
                                                                        style={{ backgroundImage: 'url(${backgroundImageUrl})' }}>
                                                                        <ul>
                                                                            <li><a href="shop.html">
                                                                                <h4>Top Cameras <br /> Bestseller
                                                                                    Products</h4>
                                                                                <h5>4K</h5>
                                                            ...
                                                            <div className="offer mt-40">
                                                                <p><b>30% OFF</b> the shipping of your first order with
                                                                    the code: <b>DUKA-SALE30</b></p>
                                                            </div>
                                                        </div>
                                                    </li>
